...
<head>
    ...
    ?>
    <link href="<?= $site_link ?>/back_assets/css2?family=Lexend:wght@100..900&family=Open+Sans:ital,wght@0,300..800;1,300..800&display=swap" rel="stylesheet">
    <?php } ?>
</head>
<body
                        ...
                        <div class="bg-theme-1-space rounded py-3 mb-3 dropdown-dontclose">
                            <div class="row gx-0">
                                ...
                                <div class="col align-self-center">
                                    ...
                                    <p><i class="bi bi-wallet2 me-2"></i>
                                        <?= $user_currency . number_format($main_balance + $investment_balance + $staking_balance) ?> <small class="opacity-50">Total Balance</small>
                                    </p>
                                </div>
                            </div>
                        </div>
...
<div class="adminuiux-wrap">
    <div class="adminuiux-sidebar">
        <div class="adminuiux-sidebar-inner">
            ...
            <?php
            $menu_items = [
                ['url' => '/user/dashboard', 'icon' => 'bi-columns-gap', 'name' => 'Dashboard'],
                    ...
                    <div class="card-body p-2">
                        <div class="row gx-2">
                            <div class="col-12 d-flex justify-content-between"><a
                                    ...
                                    href="<?= $about['link']?>" class="btn btn-square btn-link"><span
                                        class="position-relative"><i data-feather="user-check"></i> <span
                                            class="position-absolute top-0 start-100 translate-middle p-1 bg-warning rounded-circle"><span
                                                class="visually-hidden">New alerts</span> </span></span></a><a
                                    href="<?= $faq['link']?>" class="btn btn-square btn-link"><i
                                        data-feather="pocket"></i> </a><a href="<?= $contact['link']?>"
            ...
            <?php
            $extra_menu_items = [
                ['url' => '/user/referral', 'icon' => 'users', 'name' => 'Referral'],
                ['url' => '/user/settings', 'icon' => 'settings', 'name' => 'Settings'],
            ];
            ?>
            ...
            <ul class="nav flex-column menu-active-line">
                <?php foreach ($extra_menu_items as $item): ?>
                    <li class="nav-item">
                        <a href="<?= $item['url'] ?>" class="nav-link">
                            <i class="menu-icon" data-feather="<?= $item['icon'] ?>"></i>
                            <span class="menu-name"><?= $item['name'] ?></span>
                        </a>
                    </li>
                <?php endforeach; ?>
